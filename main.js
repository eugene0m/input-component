...
app.component('inputcpt', {
    ...
    template: `
            ...
            <div :class="['items', {erroritem: error}, {fullwidthitem: fullwidth}]">
                ...
                <input v-else type="text" :class="inputTextClasses" placeholder="Placeholder" :value="value">
